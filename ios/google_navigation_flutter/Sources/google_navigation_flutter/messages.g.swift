...
enum TrafficDelaySeverityDto: Int {
  case light = 0
  case medium = 1
  case heavy = 2
  case noData = 3
...
enum MapPaddingAdjustmentBehaviorDto: Int {
  case never = 0
  case always = 1
}
...
struct AutoMapOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> AutoMapOptionsDto? {
    ...
    let mapId: String? = nilOrValue(pigeonVar_list[1])
...
struct MapOptionsDto: Hashable {
  ...
  var minZoomPreference: Double? = nil
  /// The maximum zoom level that can be set for the map.
  var maxZoomPreference: Double? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> MapOptionsDto? {
    let cameraPosition = pigeonVar_list[0] as! CameraPositionDto
    let mapType = pigeonVar_list[1] as! MapTypeDto
    let compassEnabled = pigeonVar_list[2] as! Bool
    let rotateGesturesEnabled = pigeonVar_list[3] as! Bool
    let scrollGesturesEnabled = pigeonVar_list[4] as! Bool
    let tiltGesturesEnabled = pigeonVar_list[5] as! Bool
    let zoomGesturesEnabled = pigeonVar_list[6] as! Bool
    let scrollGesturesEnabledDuringRotateOrZoom = pigeonVar_list[7] as! Bool
    let mapToolbarEnabled = pigeonVar_list[8] as! Bool
    let minZoomPreference: Double? = nilOrValue(pigeonVar_list[9])
    let maxZoomPreference: Double? = nilOrValue(pigeonVar_list[10])
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct ViewCreationOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> ViewCreationOptionsDto? {
    let mapViewType = pigeonVar_list[0] as! MapViewTypeDto
    let mapOptions = pigeonVar_list[1] as! MapOptionsDto
    let navigationViewOptions: NavigationViewOptionsDto? = nilOrValue(pigeonVar_list[2])
...
/// Generated class from Pigeon that represents data sent in messages.
struct CameraPositionDto: Hashable {
  var bearing: Double
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> CameraPositionDto? {
    ...
    let target = pigeonVar_list[1] as! LatLngDto
...
struct MarkerDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> MarkerDto? {
    ...
    let options = pigeonVar_list[1] as! MarkerOptionsDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct MarkerOptionsDto: Hashable {
  var alpha: Double
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> MarkerOptionsDto? {
    ...
    let anchor = pigeonVar_list[1] as! MarkerAnchorDto
    let draggable = pigeonVar_list[2] as! Bool
    let flat = pigeonVar_list[3] as! Bool
    let consumeTapEvents = pigeonVar_list[4] as! Bool
    let position = pigeonVar_list[5] as! LatLngDto
    let rotation = pigeonVar_list[6] as! Double
    let infoWindow = pigeonVar_list[7] as! InfoWindowDto
    let visible = pigeonVar_list[8] as! Bool
    let zIndex = pigeonVar_list[9] as! Double
    let icon = pigeonVar_list[10] as! ImageDescriptorDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct ImageDescriptorDto: Hashable {
  var registeredImageId: String? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> ImageDescriptorDto? {
    let registeredImageId: String? = nilOrValue(pigeonVar_list[0])
    let imagePixelRatio: Double? = nilOrValue(pigeonVar_list[1])
    let width: Double? = nilOrValue(pigeonVar_list[2])
    let height: Double? = nilOrValue(pigeonVar_list[3])
    let type = pigeonVar_list[4] as! RegisteredImageTypeDto
...
struct InfoWindowDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> InfoWindowDto? {
    ...
    let anchor = pigeonVar_list[2] as! MarkerAnchorDto
...
struct MarkerAnchorDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> MarkerAnchorDto? {
    let u = pigeonVar_list[0] as! Double
    let v = pigeonVar_list[1] as! Double
...
struct PolygonDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PolygonDto? {
    ...
    let options = pigeonVar_list[1] as! PolygonOptionsDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct PolygonOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PolygonOptionsDto? {
    let points = pigeonVar_list[0] as! [LatLngDto?]
    let holes = pigeonVar_list[1] as! [PolygonHoleDto?]
    let clickable = pigeonVar_list[2] as! Bool
    let fillColor = pigeonVar_list[3] as! Int64
    let geodesic = pigeonVar_list[4] as! Bool
    let strokeColor = pigeonVar_list[5] as! Int64
    let strokeWidth = pigeonVar_list[6] as! Double
...
/// Generated class from Pigeon that represents data sent in messages.
struct StyleSpanStrokeStyleDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> StyleSpanStrokeStyleDto? {
    let solidColor: Int64? = nilOrValue(pigeonVar_list[0])
    let fromColor: Int64? = nilOrValue(pigeonVar_list[1])
    let toColor: Int64? = nilOrValue(pigeonVar_list[2])
...
struct StyleSpanDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> StyleSpanDto? {
    let length = pigeonVar_list[0] as! Double
    let style = pigeonVar_list[1] as! StyleSpanStrokeStyleDto
...
struct PolylineDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PolylineDto? {
    ...
    let options = pigeonVar_list[1] as! PolylineOptionsDto
...
struct PatternItemDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PatternItemDto? {
    let type = pigeonVar_list[0] as! PatternTypeDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct PolylineOptionsDto: Hashable {
  var points: [LatLngDto?]? = nil
  var clickable: Bool? = nil
  var geodesic: Bool? = nil
  var strokeColor: Int64? = nil
  var strokeJointType: StrokeJointTypeDto? = nil
  var strokePattern: [PatternItemDto?]? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PolylineOptionsDto? {
    let points: [LatLngDto?]? = nilOrValue(pigeonVar_list[0])
    let clickable: Bool? = nilOrValue(pigeonVar_list[1])
    let geodesic: Bool? = nilOrValue(pigeonVar_list[2])
    let strokeColor: Int64? = nilOrValue(pigeonVar_list[3])
    let strokeJointType: StrokeJointTypeDto? = nilOrValue(pigeonVar_list[4])
    let strokePattern: [PatternItemDto?]? = nilOrValue(pigeonVar_list[5])
    let strokeWidth: Double? = nilOrValue(pigeonVar_list[6])
    let visible: Bool? = nilOrValue(pigeonVar_list[7])
    let zIndex: Double? = nilOrValue(pigeonVar_list[8])
    let spans = pigeonVar_list[9] as! [StyleSpanDto?]
...
struct CircleDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> CircleDto? {
    ...
    let options = pigeonVar_list[1] as! CircleOptionsDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct CircleOptionsDto: Hashable {
  var position: LatLngDto
  var radius: Double
  var strokeWidth: Double
  var strokeColor: Int64
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> CircleOptionsDto? {
    let position = pigeonVar_list[0] as! LatLngDto
    let radius = pigeonVar_list[1] as! Double
    let strokeWidth = pigeonVar_list[2] as! Double
    let strokeColor = pigeonVar_list[3] as! Int64
    let strokePattern = pigeonVar_list[4] as! [PatternItemDto?]
    let fillColor = pigeonVar_list[5] as! Int64
    let zIndex = pigeonVar_list[6] as! Double
    let visible = pigeonVar_list[7] as! Bool
    let clickable = pigeonVar_list[8] as! Bool
...
struct MapPaddingDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> MapPaddingDto? {
    ...
    let left = pigeonVar_list[1] as! Int64
    let bottom = pigeonVar_list[2] as! Int64
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct NavigationHeaderStylingOptionsDto: Hashable {
  var primaryDayModeBackgroundColor: Int64? = nil
  var secondaryDayModeBackgroundColor: Int64? = nil
  var primaryNightModeBackgroundColor: Int64? = nil
  var secondaryNightModeBackgroundColor: Int64? = nil
  var largeManeuverIconColor: Int64? = nil
  var smallManeuverIconColor: Int64? = nil
  var nextStepTextColor: Int64? = nil
  var nextStepTextSize: Double? = nil
  var distanceValueTextColor: Int64? = nil
  var distanceUnitsTextColor: Int64? = nil
  var distanceValueTextSize: Double? = nil
  var distanceUnitsTextSize: Double? = nil
  var instructionsTextColor: Int64? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationHeaderStylingOptionsDto? {
    let primaryDayModeBackgroundColor: Int64? = nilOrValue(pigeonVar_list[0])
    let secondaryDayModeBackgroundColor: Int64? = nilOrValue(pigeonVar_list[1])
    let primaryNightModeBackgroundColor: Int64? = nilOrValue(pigeonVar_list[2])
    let secondaryNightModeBackgroundColor: Int64? = nilOrValue(pigeonVar_list[3])
    let largeManeuverIconColor: Int64? = nilOrValue(pigeonVar_list[4])
    let smallManeuverIconColor: Int64? = nilOrValue(pigeonVar_list[5])
    let nextStepTextColor: Int64? = nilOrValue(pigeonVar_list[6])
    let nextStepTextSize: Double? = nilOrValue(pigeonVar_list[7])
    let distanceValueTextColor: Int64? = nilOrValue(pigeonVar_list[8])
    let distanceUnitsTextColor: Int64? = nilOrValue(pigeonVar_list[9])
    let distanceValueTextSize: Double? = nilOrValue(pigeonVar_list[10])
    let distanceUnitsTextSize: Double? = nilOrValue(pigeonVar_list[11])
    let instructionsTextColor: Int64? = nilOrValue(pigeonVar_list[12])
    let instructionsFirstRowTextSize: Double? = nilOrValue(pigeonVar_list[13])
    let instructionsSecondRowTextSize: Double? = nilOrValue(pigeonVar_list[14])
    let guidanceRecommendedLaneColor: Int64? = nilOrValue(pigeonVar_list[15])
...
struct RouteTokenOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RouteTokenOptionsDto? {
    let routeToken = pigeonVar_list[0] as! String
    let travelMode: TravelModeDto? = nilOrValue(pigeonVar_list[1])
...
/// Generated class from Pigeon that represents data sent in messages.
struct DestinationsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> DestinationsDto? {
    let waypoints = pigeonVar_list[0] as! [NavigationWaypointDto?]
    let displayOptions = pigeonVar_list[1] as! NavigationDisplayOptionsDto
    let routingOptions: RoutingOptionsDto? = nilOrValue(pigeonVar_list[2])
    let routeTokenOptions: RouteTokenOptionsDto? = nilOrValue(pigeonVar_list[3])
...
/// Generated class from Pigeon that represents data sent in messages.
struct RoutingOptionsDto: Hashable {
  var alternateRoutesStrategy: AlternateRoutesStrategyDto? = nil
  var routingStrategy: RoutingStrategyDto? = nil
  var targetDistanceMeters: [Int64?]? = nil
  var travelMode: TravelModeDto? = nil
  var avoidTolls: Bool? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RoutingOptionsDto? {
    let alternateRoutesStrategy: AlternateRoutesStrategyDto? = nilOrValue(pigeonVar_list[0])
    let routingStrategy: RoutingStrategyDto? = nilOrValue(pigeonVar_list[1])
    let targetDistanceMeters: [Int64?]? = nilOrValue(pigeonVar_list[2])
    let travelMode: TravelModeDto? = nilOrValue(pigeonVar_list[3])
    let avoidTolls: Bool? = nilOrValue(pigeonVar_list[4])
    let avoidFerries: Bool? = nilOrValue(pigeonVar_list[5])
    let avoidHighways: Bool? = nilOrValue(pigeonVar_list[6])
    let locationTimeoutMs: Int64? = nilOrValue(pigeonVar_list[7])
...
struct NavigationDisplayOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationDisplayOptionsDto? {
    let showDestinationMarkers: Bool? = nilOrValue(pigeonVar_list[0])
    let showStopSigns: Bool? = nilOrValue(pigeonVar_list[1])
    let showTrafficLights: Bool? = nilOrValue(pigeonVar_list[2])
...
struct NavigationTimeAndDistanceDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationTimeAndDistanceDto? {
    let time = pigeonVar_list[0] as! Double
    let distance = pigeonVar_list[1] as! Double
    let delaySeverity = pigeonVar_list[2] as! TrafficDelaySeverityDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct NavigationAudioGuidanceSettingsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavigationAudioGuidanceSettingsDto? {
    let isBluetoothAudioEnabled: Bool? = nilOrValue(pigeonVar_list[0])
    let isVibrationEnabled: Bool? = nilOrValue(pigeonVar_list[1])
    let guidanceType: AudioGuidanceTypeDto? = nilOrValue(pigeonVar_list[2])
...
struct SimulationOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> SimulationOptionsDto? {
    let speedMultiplier = pigeonVar_list[0] as! Double
...
struct LatLngBoundsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> LatLngBoundsDto? {
    let southwest = pigeonVar_list[0] as! LatLngDto
    let northeast = pigeonVar_list[1] as! LatLngDto
...
struct SpeedingUpdatedEventDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> SpeedingUpdatedEventDto? {
    let percentageAboveLimit = pigeonVar_list[0] as! Double
    let severity = pigeonVar_list[1] as! SpeedAlertSeverityDto
...
/// Generated class from Pigeon that represents data sent in messages.
struct SpeedAlertOptionsDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> SpeedAlertOptionsDto? {
    let severityUpgradeDurationSeconds = pigeonVar_list[0] as! Double
    let minorSpeedAlertThresholdPercentage = pigeonVar_list[1] as! Double
    let majorSpeedAlertThresholdPercentage = pigeonVar_list[2] as! Double
...
/// Generated class from Pigeon that represents data sent in messages.
struct RouteSegmentTrafficDataRoadStretchRenderingDataDto: Hashable {
...
/// Generated class from Pigeon that represents data sent in messages.
struct RouteSegmentTrafficDataDto: Hashable {
...
/// Generated class from Pigeon that represents data sent in messages.
struct RouteSegmentDto: Hashable {
  var trafficData: RouteSegmentTrafficDataDto? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> RouteSegmentDto? {
    let trafficData: RouteSegmentTrafficDataDto? = nilOrValue(pigeonVar_list[0])
    let destinationLatLng = pigeonVar_list[1] as! LatLngDto
    let latLngs: [LatLngDto?]? = nilOrValue(pigeonVar_list[2])
    let destinationWaypoint: NavigationWaypointDto? = nilOrValue(pigeonVar_list[3])
...
///
/// Generated class from Pigeon that represents data sent in messages.
struct LaneDirectionDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> LaneDirectionDto? {
    let laneShape = pigeonVar_list[0] as! LaneShapeDto
    let isRecommended = pigeonVar_list[1] as! Bool
...
struct LaneDto: Hashable {
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> LaneDto? {
    let laneDirections = pigeonVar_list[0] as! [LaneDirectionDto?]
...
struct NavInfoDto: Hashable {
  ...
  /// current step.
  var distanceToCurrentStepMeters: Int64? = nil
  ...
  var distanceToFinalDestinationMeters: Int64? = nil
  /// The estimated remaining distance in meters to the next destination.
  ///
  /// Android only.
  var distanceToNextDestinationMeters: Int64? = nil
  /// The estimated remaining time in seconds along the route to the
  /// current step.
  var timeToCurrentStepSeconds: Int64? = nil
  ...
  var timeToFinalDestinationSeconds: Int64? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> NavInfoDto? {
    let navState = pigeonVar_list[0] as! NavStateDto
    let currentStep: StepInfoDto? = nilOrValue(pigeonVar_list[1])
    let remainingSteps = pigeonVar_list[2] as! [StepInfoDto?]
    let routeChanged = pigeonVar_list[3] as! Bool
    let distanceToCurrentStepMeters: Int64? = nilOrValue(pigeonVar_list[4])
    let distanceToFinalDestinationMeters: Int64? = nilOrValue(pigeonVar_list[5])
    let distanceToNextDestinationMeters: Int64? = nilOrValue(pigeonVar_list[6])
    let timeToCurrentStepSeconds: Int64? = nilOrValue(pigeonVar_list[7])
    let timeToFinalDestinationSeconds: Int64? = nilOrValue(pigeonVar_list[8])
    let timeToNextDestinationSeconds: Int64? = nilOrValue(pigeonVar_list[9])
  ...
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 129:
      ...
      if let enumResultAsInt = enumResultAsInt {
        return MapViewTypeDto(rawValue: enumResultAsInt)
      }
      return nil
    case 130:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return NavigationUIEnabledPreferenceDto(rawValue: enumResultAsInt)
      }
      return nil
    case 131:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return MapTypeDto(rawValue: enumResultAsInt)
      }
      return nil
    case 132:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 135:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return RegisteredImageTypeDto(rawValue: enumResultAsInt)
      }
      return nil
    case 136:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
    ...
    case 155:
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as! Int?)
      if let enumResultAsInt = enumResultAsInt {
        return MapPaddingAdjustmentBehaviorDto(rawValue: enumResultAsInt)
      }
      return nil
    case 156:
      return AutoMapOptionsDto.fromList(self.readValue() as! [Any?])
    case 157:
...
private class MessagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? MapViewTypeDto {
      super.writeByte(129)
      super.writeValue(value.rawValue)
    } else if let value = value as? NavigationUIEnabledPreferenceDto {
      super.writeByte(130)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(134)
      super.writeValue(value.rawValue)
    } else if let value = value as? RegisteredImageTypeDto {
      super.writeByte(135)
      super.writeValue(value.rawValue)
      ...
      super.writeByte(154)
      super.writeValue(value.rawValue)
    } else if let value = value as? MapPaddingAdjustmentBehaviorDto {
      super.writeByte(155)
      super.writeValue(value.rawValue)
    } else if let value = value as? AutoMapOptionsDto {
      super.writeByte(156)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: MapViewApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      setMapTypeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let viewIdArg = args[0] as! Int64
        let mapTypeArg = args[1] as! MapTypeDto
        do {
    ...
    if let api = api {
      getNavigationHeaderStylingOptionsChannel.setMessageHandler { message, reply in
        ...
        let viewIdArg = args[0] as! Int64
        do {
          let result = try api.getNavigationHeaderStylingOptions(viewId: viewIdArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      isTrafficPromptsEnabledChannel.setMessageHandler { message, reply in
        ...
        let viewIdArg = args[0] as! Int64
        do {
          let result = try api.isTrafficPromptsEnabled(viewId: viewIdArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setTrafficPromptsEnabledChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[1] as! Bool
        do {
          try api.setTrafficPromptsEnabled(viewId: viewIdArg, enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      isReportIncidentButtonEnabledChannel.setMessageHandler { message, reply in
        ...
        let viewIdArg = args[0] as! Int64
        do {
          let result = try api.isReportIncidentButtonEnabled(viewId: viewIdArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setReportIncidentButtonEnabledChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[1] as! Bool
        do {
          try api.setReportIncidentButtonEnabled(viewId: viewIdArg, enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ImageRegistryApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      clearRegisteredImagesChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let filterArg: RegisteredImageTypeDto? = nilOrValue(args[0])
        do {
          try api.clearRegisteredImages(filter: filterArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      getRegisteredImageDataChannel.setMessageHandler { message, reply in
        ...
        let imageDescriptorArg = args[0] as! ImageDescriptorDto
        do {
          let result = try api.getRegisteredImageData(imageDescriptor: imageDescriptorArg)
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
      ...
      getRegisteredImageDataChannel.setMessageHandler(nil)
    }
  }
}
...
protocol NavigationSessionApi {
  func createNavigationSession(abnormalTerminationReportingEnabled: Bool, behavior: TaskRemovedBehaviorDto, completion: @escaping (Result<Void, Error>) -> Void)
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NavigationSessionApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      createNavigationSessionChannel.setMessageHandler { message, reply in
        ...
        api.createNavigationSession(abnormalTerminationReportingEnabled: abnormalTerminationReportingEnabledArg, behavior: behaviorArg) { result in
          switch result {
          case .success:
            reply(wrapResult(nil))
          case .failure(let error):
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: AutoMapViewApi?, messageChannelSuffix: String = "") {
    ...
    if let api = api {
      setAutoMapOptionsChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let mapOptionsArg = args[0] as! AutoMapOptionsDto
        do {
          try api.setAutoMapOptions(mapOptions: mapOptionsArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setMapTypeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let mapTypeArg = args[0] as! MapTypeDto
        do {
    ...
    if let api = api {
      followMyLocationChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let perspectiveArg = args[0] as! CameraPerspectiveDto
    ...
    if let api = api {
      setTrafficPromptsEnabledChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[0] as! Bool
        do {
          try api.setTrafficPromptsEnabled(enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setTrafficIncidentCardsEnabledChannel.setMessageHandler { message, reply in
        ...
        let enabledArg = args[0] as! Bool
        do {
          try api.setTrafficIncidentCardsEnabled(enabled: enabledArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      isTrafficPromptsEnabledChannel.setMessageHandler { _, reply in
        do {
          let result = try api.isTrafficPromptsEnabled()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      isTrafficIncidentCardsEnabledChannel.setMessageHandler { _, reply in
        do {
          let result = try api.isTrafficIncidentCardsEnabled()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      isNavigationUIEnabledChannel.setMessageHandler { _, reply in
        do {
          let result = try api.isNavigationUIEnabled()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      getMapColorSchemeChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getMapColorScheme()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setMapColorSchemeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let mapColorSchemeArg = args[0] as! MapColorSchemeDto
        do {
          try api.setMapColorScheme(mapColorScheme: mapColorSchemeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      getForceNightModeChannel.setMessageHandler { _, reply in
        do {
          let result = try api.getForceNightMode()
          reply(wrapResult(result))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      setForceNightModeChannel.setMessageHandler { message, reply in
        let args = message as! [Any?]
        let forceNightModeArg = args[0] as! NavigationForceNightModeDto
        do {
          try api.setForceNightMode(forceNightMode: forceNightModeArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
    ...
    if let api = api {
      sendCustomNavigationAutoEventChannel.setMessageHandler { message, reply in
        ...
        let dataArg = args[1]!
        do {
          try api.sendCustomNavigationAutoEvent(event: eventArg, data: dataArg)
          reply(wrapResult(nil))
        } catch {
          reply(wrapError(error))
        }
      ...
      sendCustomNavigationAutoEventChannel.setMessageHandler(nil)
    }
  }
}
/// Generated protocol from Pigeon that represents Flutter messages that can be called from Swift.
